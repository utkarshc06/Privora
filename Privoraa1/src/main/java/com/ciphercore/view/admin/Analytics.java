...
public class Analytics {
    ...
    public VBox getContent() {
        ...
        xAxis.setTickLabelFill(
                javafx.scene.paint.Color.web("#718096")
        );
        ...
        sessionSeries.getData().add(
                new XYChart.Data<>("Mar", 260)
        );

        sessionSeries.getData().add(
                new XYChart.Data<>("Apr", 220)
        );

        sessionSeries.getData().add(
                new XYChart.Data<>("May", 360)
        );

        sessionSeries.getData().add(
                new XYChart.Data<>("Jun", 440)
        );

        sessionSeries.getData().add(
                new XYChart.Data<>("Jul", 540)
        );
        ...
        purposeSeries.getData().add(
                new XYChart.Data<>("Printing", 420)
        );

        purposeSeries.getData().add(
                new XYChart.Data<>("Scanning", 600)
        );

        purposeSeries.getData().add(
                new XYChart.Data<>("Form", 180)
        );

        purposeSeries.getData().add(
                new XYChart.Data<>("Verify", 130)
        );

        purposeSeries.getData().add(
                new XYChart.Data<>("Submit", 90)
        );

        purposeSeries.getData().add(
                new XYChart.Data<>("Other", 45)
        );
        ...
        growthSeries.getData().add(
                new XYChart.Data<>("Feb", 220)
        );

        growthSeries.getData().add(
                new XYChart.Data<>("Mar", 310)
        );

        growthSeries.getData().add(
                new XYChart.Data<>("Apr", 280)
        );

        growthSeries.getData().add(
                new XYChart.Data<>("May", 420)
        );

        growthSeries.getData().add(
                new XYChart.Data<>("Jun", 510)
        );

        growthSeries.getData().add(
                new XYChart.Data<>("Jul", 620)
        );
